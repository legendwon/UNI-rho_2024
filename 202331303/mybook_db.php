...
$query = "
    SELECT seq_no, TITLE_NM, AUTHR_NM, PUBLISHER_NM, PRC_VALUE, IMAGE_URL, loan_date, return_date
    FROM (
        SELECT loan_list.seq_no, TITLE_NM, AUTHR_NM, PUBLISHER_NM, PRC_VALUE, IMAGE_URL, loan_date,
               DATE_ADD(loan_date, INTERVAL 12 DAY) AS return_date
        FROM loan_list
